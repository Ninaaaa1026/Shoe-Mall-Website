...
<body>
	...
	<div id="wrapper">
		...
		<div id="content">
			<div class="shop_map" style="margin-left:350px; font-size:1.5em;font-weight:bold;">
				<span class="white">查看购物车</span>&nbsp;&nbsp; <span class="sure_order">确认订单信息</span>
				&nbsp;&nbsp;<span class="succes_order" style="background-color: #F60;color:white;">成功提交订单</span>
			</div>	
			<div style="margin-top:30px;margin-left:400px;margin-bottom:40px;font-size:2em;color:red;font-weight:bold;">
				<img width="50px" height="50px" src="img/OK.jpg">&nbsp;&nbsp;下单成功！
			</div>		
		</div>
